        ...
        <div className="pick-phase">
            ...
            <div className="current-turn">
                ...
                <p>
                    ...
                    {pickRounds[currentRound].length}
                </p>
            </div>
            ...
            <div className="items-grid">
                {mockItems.map((item, index) => {
                    const isBanned = bannedItems.some(
                        (ban) => ban.item === item
                    );
                    const isPicked =
                    ...
                    return (
                        ...
                        >
                            {item}
                            {isBanned && (
                                <span className="status-label banned-label">
                                    BANNED
                                </span>
                            )}
                            {isPicked && pickedBy && (
                                <span
                                    className={`status-label picked-label ${pickedBy.team.toLowerCase()}`}
                                >
